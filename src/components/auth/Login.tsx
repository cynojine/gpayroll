...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-yellow-50 to-red-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900">GPTPayroll</h2>
          <p className="mt-2 text-sm text-gray-600">
            Zambian Payroll & HR Management System
          </p>
          <div className="mt-4 h-1 bg-gradient-to-r from-green-500 via-yellow-500 via-red-500 to-black rounded-full"></div>
        </div>
        ...
        <div className="text-center">
          <p className="text-xs text-gray-500">
            © 2025 GPTPayroll. Built specifically for Zambian businesses.
          </p>
